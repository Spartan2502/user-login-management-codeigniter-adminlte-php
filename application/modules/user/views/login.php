<body class="hold-transition login-page">
	<div class="login-box">
	  	<div class="login-logo">
	    	<a href="<?php echo base_url(); ?>"><b>Sistemas SECTUR</b></a>
	  	</div>
	  	<!-- /.login-logo -->
	  	<div class="login-box-body">
	    	<p class="login-box-msg"><strong>INICIAR SESION</strong>  </p>
		    ...
		    <form action="<?php echo base_url().'user/auth_user'; ?>" method="post">
			    ...
			    <a href="forgetpassword" class="forgot ">Olvide mi contraseña!</a>
			  	<div class="row">
			  		<div class="col-xs-12">
		          		<button type="submit" class="btn btn-primary btn-block btn-flat btn-color">INICIAR SESION</button>
		        	</div>
				</div>
		    </form>
		    <!-- /.social-auth-links -->
